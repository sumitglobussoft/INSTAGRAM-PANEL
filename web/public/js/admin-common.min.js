$(function () {
	...
	$("select").selectpicker({
		...
		"show.bs.dropdown": function () {
			var a = $(this),
				b = a.siblings(".bs-select-hidden"),
				c = $(".btn.dropdown-toggle", a),
				d = $(".dropdown-menu", a),
				e = $(".inner", d),
				f = $(".selected", d).data("original-index"),
				g = f + 1,
				h = $("li", d).length,
				i = b.outerHeight(),
				j = 48,
				...
				n = 0,
				o = 1 * j / i;
			if (c.hasClass("btn-default") && c.removeClass("btn-default"), g > 3) {
				var p = h - g;
				p >= 2 ? (n = 2, m = h - (p + 3)) : 1 == p ? (n = 3, m = h - 2) : 0 == p && (n = h >= 5 ? 4 : 3,
					m = h - 3), l = n * i * o + k, e.scrollTop(j * m);
				var q = {
					top: "-" + l + "px"
				};
				d.css(q);
		...
		"hide.bs.dropdown": function (a) {
			var b = $(this),
				c = b.siblings(".bs-select-hidden");
			$(".dropdown-menu", b), setTimeout(function () {
				c.focus();
			}, 0);
		}
	});
