...
var Demo = function () {
    ...
    var handleTheme = function () {
        ...
        if ($('.sidebar-pos-option').attr("disabled") === false) {
            $('.sidebar-pos-option', panel).val(InstaPanel.isRTL() ? 'right' : 'left');
        }
        ...
        var setColor = function (color) {
            var color_ = (InstaPanel.isRTL() ? color + '-rtl' : color);
    ...
    var setThemeStyle = function(style) {
        ...
        file = (InstaPanel.isRTL() ? file + '-rtl' : file);

        $('#style_components').attr("href", InstaPanel.getGlobalCssPath() + file + ".css");
