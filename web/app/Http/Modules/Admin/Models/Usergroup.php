...
class Usergroup extends Model
{
    ...
    protected $fillable = ['usergroup_id', 'usergroup_name', 'usergroup_status', 'updated_at', 'created_at'];

    public static function getInstance()
    {
        if (!is_object(self::$_instance))  //or if( is_null(self::$_instance) ) or if( self::$_instance == null )
            self::$_instance = new Usergroup();
    ...
    public function getAllUsergroupsWhereTemp($where, $selectedColumns = ['*'])
    {
        if (func_num_args() > 0) {
    ...
    public function deleteUserGroupWhere()
    {
        if (func_num_args() > 0) {
            $where = func_get_arg(0);
            try {
    ...
    public function getAllUsergroupsWhere($where, $selectedColumns = ['*'])
    {
        ...
        if (func_num_args() > 0) {
            ...
            if ($result) {
                $returnData['code'] = 200;
                $returnData['message'] = 'All usergroups.';
            } else {
                $returnData['code'] = 400;
    ...
    public function getUsergroupWhere($where, $selectedColumns = ['*'])
    {
        $returnData = array('code' => 400, 'message' => 'Argument Not Passed.', 'data' => null);
        if (func_num_args() > 0) {
            $where = func_get_arg(0);
            ...
            if ($result) {
                $returnData['code'] = 200;
                $returnData['message'] = 'Usergroups details.';
            } else {
                $returnData['code'] = 400;
                $returnData['message'] = 'No data found.';
            }
    ...
    public function updateUsergroupWhere()
    {
        $returnData = array('code' => 400, 'message' => 'Argument Not Passed.', 'data' => null);
        if (func_num_args() > 0) {
            $data = func_get_arg(0);
