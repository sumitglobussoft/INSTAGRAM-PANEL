        ...
        <ul id="mini-nav" class="clearfix">
            ...
            <li class="list-box dropdown">
                <a id="drop5" href="javascript:;">
                    BALANCE :
                    <span class="label label-success" style="font-size: 16px;"> <i
                                class="fa fa-usd "></i>@if(isset(Session::get('ig_supplier')['account_bal'])) {{Session::get('ig_supplier')['account_bal']}} @else
                            0.0000 @endif </span>
                </a>
            </li>
