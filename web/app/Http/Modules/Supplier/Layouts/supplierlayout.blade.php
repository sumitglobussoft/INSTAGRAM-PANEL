        ...
        <ul id="mini-nav" class="clearfix">
            ...
            <li class="list-box dropdown">
                <a id="drop5" href="javascript:;">
                    BALANCE :
                    <span class="label label-success" style="font-size: 16px;"> <i class="fa fa-inr"></i> {{Session::get('ig_supplier')['account_bal']}}</span>
                </a>
            </li>
            <li class="list-box user-profile">
                <a id="drop7" href="#" role="button" class="dropdown-toggle user-avtar" data-toggle="dropdown">
                    <img src="{{Session::get('ig_supplier')['profile_pic']}}" alt="user">
                </a>
...
<div class="dashboard-container">
    ...
    <div class="container">
        ...
        <div id='cssmenu'>
            <ul class="wcontent">
                <li class="active">
                    <a class="navbar-links" href="/supplier/dashboard"><i class="fa fa-home"></i>Home</a>
                </li>
                <li>
                    <a href="/supplier/myAccount"  class="navbar-links">
                        <i class="fa fa-user"></i> My Account
                    </a>
                </li>
                <li class="">
                    <a href="javascript:;"  class="navbar-links"><i class="fa fa-shopping-cart"></i>Market</a>
                    <ul>
                ...
                <li class="">
                    <a href="javascript:;"  class="navbar-links"><i class="fa fa-instagram"></i>Instagram Tool</a>
                    <ul>
