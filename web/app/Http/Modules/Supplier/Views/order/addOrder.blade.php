            ...
            <div class="widget">
                <div class="widget-header">
                    <div class="title"> Add new Order(s) &nbsp;&nbsp;
                        <small><a href="javascript:;"> Single Order </a> | <a href="javascript:;"> Bulk Orders </a>
                        </small>
                    </div>
                </div>
                        ...
                        <div class="col-md-12">
                            <form class="font-segoe" action="/supplier/addOrder" method="post" id="addOrderForm"
                                ...
                                <div class="form-group" id="commentOptionArea" hidden>
                                    ...
                                    <div class="form-group">
                                        <select class="js-example-responsive form-control" name="commentType"
                                                id="commentType">
                                    ...
                                    <div class="form-group" id="customCommentRadioButton" hidden>
                                        ...
                                        <label class="control-label" style="margin-left: 1%;"> Select Comments</label>
                                    </div>
                                    ...
                                    <div class="form-group" id="customCommentTextArea" hidden>
                                        <textarea class="form-control" name="commentsTextArea" id="commentsTextArea"
                                                  rows="6"></textarea><span id="commentsTextArea_error"></span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime" class="form-control" name="starting_time" id="starting_time" placeholder="Please select scheduling Time">
                                </div>


                                <p class="text-muted">
                                    <small>By placing this order you agree to our Terms of Service and Refund Policy and
                                        you understand and agree that this action cannot be canceled once started or
                                        initiated. Thanks for your order :)
                                    </small>
                                </p>
                                <div class="form-group">
                                    <button class="btn btn-success" type="submit" name="submit_order" id="submit_order"><i
                                                class="fa fa-arrow-circle-right"></i> Place Order
                                    </button>
                                    <button class="btn default" style="margin-left:1%;" type="button" name="reset_order" id="reset">Reset</button>

                                    <h4 style="color: green; padding-left: 5%">@if(session('successMessage')) <?php echo session('successMessage'); ?> @endif</h4>
                                    <h4 style="color: red; padding-left: 5%">@if(session('errorMessage')) <?php session('errorMessage'); ?> @endif</h4>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover table-light font-segoe">
                                ...
                                <tr>
                                    ...
                                    <td align="right" id="current_balance">{{Session::get('ig_supplier')['account_bal']}} €</td>
                                </tr>
                                <tr>
                                    <td>Pricing &amp; Info</td>
                                    <td align="right"><a href="https://www.igerslike.com/market/pricing/">Click here</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#commentType').change(function (e) {
                e.preventDefault();
                if ($('#commentType option:selected').attr('value') == 1) {
            ...
            }, "Please Write atleast 5 Comments (1 comment/line)");
