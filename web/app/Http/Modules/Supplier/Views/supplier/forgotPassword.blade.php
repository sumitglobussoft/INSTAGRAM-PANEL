...
<div class="login">
    ...
    <form action="/supplier/forgotPassword" method="post" id="forgotPasswordForm" style="margin-bottom: 3%;">
        ...
        <span class="text-white" style="margin-top:3%;">Back to LogIn ?? <a href="/supplier/login"
